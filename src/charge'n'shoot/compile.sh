...
arm-linux-gnueabihf-gcc -o chargenshoot chargenshoot.c `pkg-config --cflags --libs ecore elementary` --sysroot=./standard-armv7l/ -Wl,-dynamic-linker,/lib/ld-2.13.so
